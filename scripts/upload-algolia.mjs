...
const processRecords = async () => {
  ...
  console.log(picocolors.green(`Successfully parsed tags.json. Found ${Object.keys(data).length} icons.`));
  ...
  console.log(picocolors.green(`Transformed ${objects.length} objects for indexing.`));
